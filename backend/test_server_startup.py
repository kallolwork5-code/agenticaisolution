...
def print_startup_instructions():
    ...
    print("   - GET  http://localhost:9000/api/ai-workflows/available-agents")
    print("   - GET  http://localhost:9000/api/ai-workflows/workflow-templates")
    print("   - POST http://localhost:9000/api/ai-workflows/execute")
    print()
